...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (rvUsers != null) {
            ...
            rvUsers.addItemDecoration(new DividerItemDecoration(this, StaggeredGridLayoutManager.VERTICAL, 10));
            rvUsers.addItemDecoration(new DividerItemDecoration(this, StaggeredGridLayoutManager.HORIZONTAL, 10));
            rvUsers.setAdapter(new UserAdapter(this, Arrays.asList(Data.URLS)));
        }
    }
